...
public interface IService
{
	...
	/// <returns>A task that represents the asynchronous operation and returns the DTO of
	/// the created <see cref="RoleOption"/>.</returns>
	...
	/// <param name="offset">The number of <see cref="RoleOption"/> to skip before
	/// starting to return results.</param>
	/// <param name="filter">An optional lambda expression to filter the <see cref="RoleOption"/>.</param>
	/// <returns>A task that represents the asynchronous operation and returns a
	/// collection of DTOs of <see cref="RoleOption"/>.</returns>
	...
	/// <returns>A task that represents the asynchronous operation and returns the DTO of
	/// the <see cref="RoleOption"/>, or null if not found.</returns>
	...
	/// <returns>A task that represents the asynchronous operation and returns the DTO of
	/// the updated <see cref="RoleOption"/>, or null if not found.</returns>
	...
	/// <returns>A task that represents the asynchronous operation and returns true if
	/// the deletion was successful, false otherwise.</returns>
