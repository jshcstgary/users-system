...
public interface IRepository
{
	...
	/// created <see cref="User"/> entity.</returns>
	...
	/// collection of <see cref="User"/> entities.</returns>
	public Task<IEnumerable<User>> GetAll(int limit, int offset, Expression<Func<User, bool>>? filter = null);

	/// <summary>
	/// Gets a single <see cref="User"/> entity from the database that meets the
	/// specified filter.
	/// </summary>
	/// <param name="filter">The lambda expression to filter the entity.</param>
	/// <returns>A task that represents the asynchronous operation and returns the
	/// <see cref="User"/> entity, or <c>null</c> if none is found.</returns>
	...
	/// <returns>A task that represents the asynchronous operation and returns the
	/// updated <see cref="User"/> entity.</returns>
