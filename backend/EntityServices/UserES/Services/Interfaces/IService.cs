...
public interface IService
{
	...
	/// the created <see cref="User"/>.</returns>
	...
	/// <param name="offset">The number of <see cref="User"/> to skip before
	...
	/// collection of DTOs of <see cref="User"/>.</returns>
	...
	/// <returns>A task that represents the asynchronous operation and returns the DTO of
	/// the <see cref="User"/>, or null if not found.</returns>
	...
	/// <returns>A task that represents the asynchronous operation and returns the DTO of
	/// the updated <see cref="User"/>, or null if not found.</returns>
