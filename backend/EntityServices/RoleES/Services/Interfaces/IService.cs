...
public interface IService
{
	...
	/// the created <see cref="Role"/>.</returns>
	...
	/// <param name="offset">The number of <see cref="Role"/> to skip before
	...
	/// collection of DTOs of <see cref="Role"/>.</returns>
	...
	/// <returns>A task that represents the asynchronous operation and returns the DTO of
	/// the <see cref="Role"/>, or null if not found.</returns>
	...
	/// <returns>A task that represents the asynchronous operation and returns the DTO of
	/// the updated <see cref="Role"/>, or null if not found.</returns>
