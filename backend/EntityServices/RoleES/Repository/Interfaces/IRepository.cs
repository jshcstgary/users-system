...
public interface IRepository
{
	...
	/// </summary>
	/// <param name="role">The RoleO ption entity to be created.</param>
	/// <returns>A task that represents the asynchronous operation and returns the
	/// created <see cref="Role"/> entity.</returns>
	...
	/// <param name="offset">The number of entities to omit before starting to return
	/// results.</param>
	...
	/// collection of <see cref="Role"/> entities.</returns>
	public Task<IEnumerable<Role>> GetAll(int limit, int offset, Expression<Func<Role, bool>>? filter = null);

	/// <summary>
	/// Gets a single <see cref="Role"/> entity from the database that meets the
	/// specified filter.
	/// </summary>
	/// <param name="filter">The lambda expression to filter the entity.</param>
	/// <returns>A task that represents the asynchronous operation and returns the
	/// <see cref="Role"/> entity, or <c>null</c> if none is found.</returns>
	...
	/// <returns>A task that represents the asynchronous operation and returns the
	/// updated <see cref="Role"/> entity.</returns>
