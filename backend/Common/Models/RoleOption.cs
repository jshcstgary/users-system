...
public class RoleOption
{
	...
	/// <summary>
	/// The name of the role option. This should be a descriptive and unique value.
	/// Examples might include "Users", "Roles", etc.
	/// </summary>
	public string Name { get; set; } = null!;

	/// <summary>
	/// The link or path associated with this role option. This could be a full URL
	/// starting with '/' that corresponds to a specific functionality or page within the application.
	/// </summary>
